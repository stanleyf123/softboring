...
import { ACTIVITY_EXPORT_FILENAME } from "@/lib/activity-export";
import { getTranslations } from "next-intl/server";

export async function SoftActivityExport({ softPlus }: { softPlus: boolean }) {
  ...
  return (
    ...
    >
      ...
      <a
        href="/api/account/activity/export"
        download={ACTIVITY_EXPORT_FILENAME}
